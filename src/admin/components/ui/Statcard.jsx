  ...
  const cards = [
    {
      ...
      icon: "🎓",
      bg: "bg-purple-100",
      change: `${stats.students} enrolled`,
      up: true,
    },
    {
      id: 2,
    ...
    <div className="grid grid-cols-4 mb-6">
      {cards.map((card, i) => (
        <div
          ...
          className="bg-white p-5 shadow-sm flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 cursor-default"
        >
          <div className={`w-14 h-14 ${card.bg} rounded-2xl flex items-center justify-center text-2xl flex-shrink-0`}>
            {card.icon}
          </div>
          <div>
