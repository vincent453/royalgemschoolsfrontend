    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="w-full h-screen bg-white shadow-xl overflow-hidden flex">
        ...
        <div className="w-full lg:w-[45%] px-10 md:px-14 flex flex-col justify-center gap-8">
          ...
          {/* Heading */}
          <div>
            <h2 className="font-jost font-bold text-gray-800 text-2xl">Welcome back</h2>
            <p className="font-dm-sans text-gray-400 text-sm mt-1">
        ...
        <div className="hidden lg:flex w-[55%] bg-gradient-to-br from-[#f0f1ff] via-[#fce4ff] to-[#e8f4ff]
          ...
          {[
            ...
            <span key={i} className={`absolute ${size} animate-pulse`}
              style={{ top, left, right, color, animationDelay: `${i * 0.4}s` }}>✦</span>
          ))}
          ...
          <div className="relative z-10 w-[78%]">
            ...
            <img src={loginbanner} alt="Students studying"
