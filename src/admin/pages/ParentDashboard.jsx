        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          ...
          {results.length === 0 ? (
            ...
            <div className="flex flex-col gap-3">
              {results.map((r) => (
                <div key={r._id}
                  className="flex items-center justify-between gap-4 p-4 rounded-xl border border-gray-100 hover:border-[#A033A0]/30 hover:bg-[#fdf8ff] transition-all duration-200">
