const ContactForm = ({
  ...
  return (
    <section className="py-12 sm:py-16 px-4 sm:px-6 md:px-10 lg:px-[7rem] bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 sm:gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-5 sm:gap-6">
                ...
                <div className="flex flex-col gap-2 w-full">
                  <label className="font-dm-sans text-gray-700 text-sm font-medium">
                    Name
                  </label>
          ...
          {/* Right — Map */}
          <div className="w-full lg:w-1/2">
            <div className="min-h-[300px] sm:min-h-[400px] rounded-2xl overflow-hidden shadow-md">
              <iframe
                src={mapSrc}
                width="100%"
                height="100%"
